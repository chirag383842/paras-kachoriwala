import { Clock, Users, RefreshCw, AlertCircle, Calendar, Navigation, Banknote, Ticket } from 'lucide-react';
...
export default function LiveStoreStatus() {
  const { data, loading, error, computed } = useStoreStatus();
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-charcoal-900 to-charcoal-800 text-white shadow-warm">
        ...
        <div className="relative p-7 sm:p-10 lg:p-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <div className="mt-4 flex items-center gap-4">
                {loading ? (
                  ...
                  <span className="inline-flex items-center gap-2 text-red-300 text-sm font-semibold">
            ...
            {/* When CLOSED: Show next opening schedule & hours info, hiding operational rush meters */}
            {!isOpen && !loading && (
